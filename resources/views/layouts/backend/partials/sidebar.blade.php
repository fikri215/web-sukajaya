...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <a href="#Suka Jaya" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">Suka Jaya</span>
    </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('service*') ? 'active' : '' }}">
            <a href="{{ route('service.index') }}" class="menu-link">
                ...
                <div data-i18n="Analytics">Layanan Kami</div>
            </a>
        </li>
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Preview Page</span>
        </li>

        <!-- Setting -->
        <li class="menu-item">
            <a href="{{ route('homepage') }}" target="_blank" class="menu-link">
            <i class="menu-icon tf-icons bx bx-tv"></i>
            <div data-i18n="Analytics">Lihat Website</div>
            </a>
        </li>
